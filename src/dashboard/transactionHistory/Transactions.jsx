  ...
  return (
    <div className="flex justify-center items-center flex-col gap-11 mt-32 ml-48">
      ...
      <div className="w-[960px] h-[700px] py-[98px] px-[25px] gap-3 bg-white ml-[785px] mt-[-15px] rounded-lg">
        <div className="w-[800px] h-8 gap-11 mt-[-50px] ml-2">
          <div
            className="font-normal text-[18px] flex flex-row items-center justify-between "
        ...
        {transactions.map((transaction) => (
          <div key={transaction.Reference} className="w-[800px] gap-3 my-4">
            <div className="w-[910px] h-[62px] rounded-[15px] py-[17px] px-[32px] bg-gray-100">
              <div className="flex flex-row items-center justify-between w-[830px] ml-[-10px]">
                <p className="font-normal text-[18px]">{transaction.Reference}</p>
                <p className="font-normal text-[18px]">{transaction.AmountSent}</p>
                <p className="font-normal text-[18px]">{transaction.Rate}</p>
                <p className="font-normal text-[18px]">{transaction.Channel}</p>
                <p className="font-normal text-[18px]">{transaction.Recipient}</p>
                <p className={`font-normal text-[18px] w-1/6 text-center ${transaction.Status === 'Completed' ? 'text-green-500' : 'text-red-500'}`}>
                {transaction.Status}
              </p>
              </div>
            </div>
